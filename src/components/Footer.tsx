...
export const Footer: React.FC = () => {
  return (
    <footer className="relative z-20 w-full bg-wd-deep-blue text-white/70 py-12 pb-[max(5rem,calc(3rem+env(safe-area-inset-bottom)))] md:pb-12 px-5 sm:px-8 md:px-12 lg:px-16 border-t border-white/10">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-sans text-xs text-white/75 max-w-md leading-relaxed">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <a
            ...
            className="font-sans text-xs uppercase tracking-wider text-white/75 hover:text-white transition-colors flex items-center gap-2 py-2.5 px-3 rounded hover:bg-white/5 min-h-[44px]"
          >
